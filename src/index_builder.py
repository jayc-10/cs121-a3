...
def build_index_from_directory(data_dir: Path) -> tuple[InvertedIndex, set[str]]:
    """
    Build inverted index from all HTML files in a directory (non-recursive).
    ...
    *data_dirs: Path,
    ...
    for data_dir in data_dirs:
        ...
        if not data_dir.exists():
            continue
        sub_index, sub_docs = build_index_from_directory(data_dir)
